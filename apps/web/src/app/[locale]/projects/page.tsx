...
function getViewModeOptions(t: (key: "view.grid" | "view.list") => string) {
	return [
		{ mode: "grid" as const, icon: GridViewIcon, label: t("view.grid") },
		{
			mode: "list" as const,
...
function SortDropdown({ children }: { children: React.ReactNode }) {
	const t = useTranslations("pages.projects.sort");
		...
		<Card className="bg-background overflow-hidden border-none p-0">
			...
			<CardContent className="flex flex-col gap-2 px-0 pt-4">
				...
				<div className="text-muted-foreground flex items-center gap-1.5 text-sm">
					...
					<span>
						{t("createdOn", { date: formatDate({ date: project.createdAt }) })}
					</span>
				</div>
			</CardContent>
		</Card>
	...
	const listRowContent = (
		<div className="flex items-center gap-3 flex-1 min-w-0">
			...
			<span className="text-muted-foreground text-sm shrink-0 hidden sm:block">
				{durationLabel ?? t("durationFallback")}
			</span>
...
function ProjectContextMenuContent({
	...
	const t = useTranslations("pages.projects.actions");
	return (
		<ContextMenuContent>
			<ContextMenuItem
			...
			<div className="flex flex-col items-center justify-center gap-5 py-16 text-center">
				<div className="flex flex-col items-center gap-8">
					...
					<div className="flex flex-col items-center gap-3">
						<h3 className="text-lg font-medium">{t("empty.searchTitle")}</h3>
	...
	return (
		<div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
			<div className="flex flex-col items-center gap-2">
				...
				<h3 className="text-lg font-medium">{t("empty.noProjectsTitle")}</h3>
				<p className="text-muted-foreground max-w-md">
